...
ecr_repository_names = [
  "openhelp/dev/adservice",
  "openhelp/dev/cartservice",
  "openhelp/dev/checkoutservice",
  "openhelp/dev/currencyservice",
  "openhelp/dev/emailservice",
  "openhelp/dev/frontend",
  "openhelp/dev/loadgenerator",
  "openhelp/dev/paymentservice",
  "openhelp/dev/productcatalogservice",
  "openhelp/dev/recommendationservice",
  "openhelp/dev/shippingservice",
]

ecr_force_delete = true
ecr_untagged_retention_days   = 30
ecr_tagged_image_count        = 30

# Two protected application/project S3 buckets.
application_bucket_force_destroy = true
application_bucket_noncurrent_retention_days = 30
